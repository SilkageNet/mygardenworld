...
// 	protoc        (unknown)
// source: mygardenworld/v1/query_union.proto
...
func (x *UnionView) Reset() {
	*x = UnionView{}
	mi := &file_mygardenworld_v1_query_union_proto_msgTypes[0]
...
func (*UnionView) Descriptor() ([]byte, []int) {
	return file_mygardenworld_v1_query_union_proto_rawDescGZIP(), []int{0}
}
...
func (x *FmlRaceView) Reset() {
	*x = FmlRaceView{}
	mi := &file_mygardenworld_v1_query_union_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FmlRaceView) Descriptor() ([]byte, []int) {
	return file_mygardenworld_v1_query_union_proto_rawDescGZIP(), []int{1}
}
...
func (x *FmlRaceTask) Reset() {
	*x = FmlRaceTask{}
	mi := &file_mygardenworld_v1_query_union_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FmlRaceTask) Descriptor() ([]byte, []int) {
	return file_mygardenworld_v1_query_union_proto_rawDescGZIP(), []int{2}
}
...
func (x *FmlRaceTaken) Reset() {
	*x = FmlRaceTaken{}
	mi := &file_mygardenworld_v1_query_union_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FmlRaceTaken) Descriptor() ([]byte, []int) {
	return file_mygardenworld_v1_query_union_proto_rawDescGZIP(), []int{3}
}
...
func (x *FmlLandView) Reset() {
	*x = FmlLandView{}
	mi := &file_mygardenworld_v1_query_union_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FmlLandView) Descriptor() ([]byte, []int) {
	return file_mygardenworld_v1_query_union_proto_rawDescGZIP(), []int{4}
}
...
var File_mygardenworld_v1_query_union_proto protoreflect.FileDescriptor

const file_mygardenworld_v1_query_union_proto_rawDesc = "" +
	"\n" +
	"\"mygardenworld/v1/query_union.proto\x12\x10mygardenworld.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x80\x03\n" +
	"\tUnionView\x12\x1d\n" +
	"\n" +
	...
	"\n" +
	"flower_lvl\x18\x0e \x01(\x05R\tflowerLvlB\xd2\x01\n" +
	"\x14com.mygardenworld.v1B\x0fQueryUnionProtoP\x01ZHgithub.com/SilkageNet/mygardenworld/gen/mygardenworld/v1;mygardenworldv1\xa2\x02\x03MXX\xaa\x02\x10Mygardenworld.V1\xca\x02\x10Mygardenworld\\V1\xe2\x02\x1cMygardenworld\\V1\\GPBMetadata\xea\x02\x11Mygardenworld::V1b\x06proto3"

var (
	file_mygardenworld_v1_query_union_proto_rawDescOnce sync.Once
	file_mygardenworld_v1_query_union_proto_rawDescData []byte
)

func file_mygardenworld_v1_query_union_proto_rawDescGZIP() []byte {
	file_mygardenworld_v1_query_union_proto_rawDescOnce.Do(func() {
		file_mygardenworld_v1_query_union_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mygardenworld_v1_query_union_proto_rawDesc), len(file_mygardenworld_v1_query_union_proto_rawDesc)))
	})
	return file_mygardenworld_v1_query_union_proto_rawDescData
}

var file_mygardenworld_v1_query_union_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_mygardenworld_v1_query_union_proto_goTypes = []any{
...
var file_mygardenworld_v1_query_union_proto_depIdxs = []int32{
...
func init() { file_mygardenworld_v1_query_union_proto_init() }
func file_mygardenworld_v1_query_union_proto_init() {
	if File_mygardenworld_v1_query_union_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mygardenworld_v1_query_union_proto_rawDesc), len(file_mygardenworld_v1_query_union_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mygardenworld_v1_query_union_proto_goTypes,
		DependencyIndexes: file_mygardenworld_v1_query_union_proto_depIdxs,
		MessageInfos:      file_mygardenworld_v1_query_union_proto_msgTypes,
	}.Build()
	File_mygardenworld_v1_query_union_proto = out.File
	file_mygardenworld_v1_query_union_proto_goTypes = nil
	file_mygardenworld_v1_query_union_proto_depIdxs = nil
}
