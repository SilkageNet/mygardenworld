...
const (
	...
	// Pearl labor hire and its production claim events.
	WorkspaceLogCategory_WORKSPACE_LOG_CATEGORY_HIRE WorkspaceLogCategory = 9
)
...
const file_mygardenworld_v1_workspace_common_proto_rawDesc = "" +
	...
	"\x1eACCOUNT_HEALTH_SESSION_EXPIRED\x10\x04*\xfd\x02\n" +
	...
	"\x1dWORKSPACE_LOG_CATEGORY_SYSTEM\x10\b\x12\x1f\n" +
	"\x1bWORKSPACE_LOG_CATEGORY_HIRE\x10\t*\xbf\x04\n" +
