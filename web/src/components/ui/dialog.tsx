    ...
    <DialogContext.Provider value={{ onOpenChange, titleId }}>
      ...
      >
        ...
        <div
          ...
          className={useStableMobilePortal ? "absolute z-50 flex h-auto justify-center" : "absolute inset-0 z-10 flex items-center justify-center sm:p-4"}
          style={useStableMobilePortal ? {
            top: `calc(${portalTop}px + 5dvh)`,
            right: "max(0.75rem, env(safe-area-inset-right))",
            left: "max(0.75rem, env(safe-area-inset-left))",
          } : {
            // Keep safe-area padding in inline style. Tailwind arbitrary
            // env(safe-area-inset-*) classes can be corrupted by some Node/Turbopack
            // toolchains during CSS generation.
