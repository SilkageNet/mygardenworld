...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-md border border-transparent bg-clip-padding text-sm font-semibold whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/35 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-55 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-[0_10px_20px_rgba(255,111,97,0.26)] hover:bg-primary/90 hover:shadow-[0_13px_24px_rgba(255,111,97,0.32)]",
        outline:
          "border-border/70 bg-card/72 text-foreground shadow-sm shadow-sky-900/10 hover:border-ring/55 hover:bg-white/82 hover:text-foreground aria-expanded:bg-white/82 aria-expanded:text-foreground dark:border-white/10 dark:bg-input/42 dark:shadow-black/20 dark:hover:bg-input/64",
        secondary:
          "bg-secondary text-secondary-foreground shadow-sm shadow-sky-900/10 hover:bg-secondary/82 aria-expanded:bg-secondary aria-expanded:text-secondary-foreground dark:shadow-black/20",
        ghost:
          "text-foreground/82 hover:bg-white/62 hover:text-foreground aria-expanded:bg-white/70 aria-expanded:text-foreground dark:hover:bg-muted/60",
        destructive:
