...
var featureSpecs = []FeatureSpec{
	...
	{ID: "union.race.take", Label: "公会竞赛接任务", Category: CategoryUnion, Domain: "union.race.take", Action: "take", Status: PlanStatusManaged, Executable: true},
	{ID: "union.race.finish", Label: "公会竞赛交任务", Category: CategoryUnion, Domain: "union.race.finish", Action: "finish", Status: PlanStatusManaged, Executable: true},
	{ID: "union.race.upgrade", Label: "公会竞赛升级任务", Category: CategoryUnion, Domain: "union.race.upgrade", Action: "upgrade", Status: PlanStatusManaged, Executable: true},
	{ID: "union.race.delete", Label: "公会竞赛删除低分任务", Category: CategoryUnion, Domain: "union.race.delete", Action: "delete", Status: PlanStatusManaged, Executable: true},
