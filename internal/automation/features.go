...
var featureSpecs = []FeatureSpec{
	...
	{ID: "order.flower_art", Label: "花艺/花架", Category: CategoryFlowerArt, Domain: "order.flower_art", Action: "sell", Status: PlanStatusManaged, Executable: true},
	...
	{ID: "order.flower_art_claim", Label: "花架收益", Category: CategoryFlowerArt, Domain: "order.flower_art", Action: "claim", Status: PlanStatusManaged, Executable: true},
