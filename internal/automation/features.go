...
var featureSpecs = []FeatureSpec{
	...
	{ID: "activity.actDessert.reward_boxes", Label: "香卉甜糕奖励箱", Category: CategoryActivity, Domain: "activity.actDessert", Action: "open_box", Status: PlanStatusBlocked, BlockedReasons: []string{"缺少 actDessert.openBox 成功抓包，保持阻塞"}},
	{ID: "activity.actDessert.game", Label: "香卉甜糕自动游玩", Category: CategoryActivity, Domain: "activity.actDessert", Action: "play", Status: PlanStatusBlocked, BlockedReasons: []string{"物理回放及自然终态证据尚未通过，保持阻塞"}},
