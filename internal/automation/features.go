...
var featureSpecs = []FeatureSpec{
	...
	{ID: "basic.friend_list_sync", Label: "好友列表同步", Category: CategoryBasic, Domain: "basic.friend_list", Action: "sync", Status: PlanStatusManaged, Executable: true},
	{ID: "basic.friend_touch", Label: "好友摸花", Category: CategoryBasic, Domain: "basic.friend_touch", Action: "steal", Status: PlanStatusManaged, Executable: true},
	{ID: "basic.friend_touch_buy", Label: "购买摘花次数", Category: CategoryBasic, Domain: "basic.friend_touch", Action: "buy", Status: PlanStatusManaged, Executable: true},
