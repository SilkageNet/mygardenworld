...
var featureSpecs = []FeatureSpec{
	...
	{ID: "basic.zoo_handle_event", Label: "宠物事件", Category: CategoryBasic, Domain: "basic.zoo.event", Action: "handle_event", Status: PlanStatusBlocked, BlockedReasons: []string{"宠物字段事件推断已停用，等待服务端日志判定"}},
