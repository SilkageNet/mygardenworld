...
var featureSpecs = []FeatureSpec{
	...
	{ID: "plant.friend_steal_elves", Label: "摸取花灵", Category: CategoryPlant, Domain: "farm.elves_steal", Action: "steal_elves", Status: PlanStatusManaged, Executable: true},
	{ID: "plant.elves", Label: "花灵", Category: CategoryPlant, Domain: "farm.elves", Action: "run", Status: PlanStatusSyncOnly, SyncOnly: true},
	{ID: "plant.elves_plant_harvest", Label: "花灵副花收取", Category: CategoryPlant, Domain: "farm.harvest", Action: "harvest", Status: PlanStatusManaged, Executable: true},
	{ID: "plant.elves_night_harvest", Label: "夜间花灵收取", Category: CategoryPlant, Domain: "farm.harvest", Action: "harvest", Status: PlanStatusManaged, Executable: true},
	{ID: "plant.elves_plant_speed_up", Label: "花灵种植加速", Category: CategoryPlant, Domain: "farm.speed_up", Action: "speed_up", Status: PlanStatusManaged, Executable: true},
	{ID: "plant.elves_aid_sync", Label: "花灵协助同步", Category: CategoryPlant, Domain: "farm.elves_aid", Action: "sync", Status: PlanStatusManaged, Executable: true},
	{ID: "plant.elves_aid_request", Label: "申请花灵协助", Category: CategoryPlant, Domain: "farm.elves_aid", Action: "request", Status: PlanStatusManaged, Executable: true},
	{ID: "plant.elves_aid_receive", Label: "领取花灵协助", Category: CategoryPlant, Domain: "farm.elves_aid", Action: "claim", Status: PlanStatusManaged, Executable: true},
	{ID: "plant.elves_aid_help", Label: "协助好友花灵", Category: CategoryPlant, Domain: "farm.elves_aid", Action: "help", Status: PlanStatusManaged, Executable: true},
	...
	{ID: "plant.elves_pass", Label: "花灵密令", Category: CategoryPlant, Domain: "plant.elves_pass", Action: "claim", Status: PlanStatusManaged, Executable: true},
	{ID: "plant.elves_pass_sync", Label: "花灵密令同步", Category: CategoryPlant, Domain: "plant.elves_pass", Action: "sync", Status: PlanStatusManaged, Executable: true},
	{ID: "plant.flower_pass", Label: "花之密令", Category: CategoryPlant, Domain: "plant.flower_pass", Action: "claim", Status: PlanStatusManaged, Executable: true},
	{ID: "plant.flower_pass_sync", Label: "花之密令同步", Category: CategoryPlant, Domain: "plant.flower_pass", Action: "sync", Status: PlanStatusManaged, Executable: true},
