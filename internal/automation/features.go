...
var featureSpecs = []FeatureSpec{
	...
	{ID: "plant.friend_steal_elves", Label: "摸取花灵", Category: CategoryElves, Domain: "farm.elves_steal", Action: "steal_elves", Status: PlanStatusManaged, Executable: true},
	...
	{ID: "plant.elves", Label: "花灵派遣", Category: CategoryPlant, Domain: "farm.elves", Action: "run", Status: PlanStatusSyncOnly, SyncOnly: true},
	...
	{ID: "basic.task_daily_advance", Label: "每日任务自动推进", Category: CategoryBasic, Domain: "basic.task.daily", Action: "advance", Status: PlanStatusManaged, Executable: true},
	...
	{ID: "basic.flower_pass_sync", Label: "花之密令同步", Category: CategoryBasic, Domain: "basic.flower_pass", Action: "sync", Status: PlanStatusManaged, Executable: true},
	{ID: "basic.flower_pass", Label: "花之密令", Category: CategoryBasic, Domain: "basic.flower_pass", Action: "claim", Status: PlanStatusManaged, Executable: true},
	{ID: "basic.flower_pass_advance", Label: "花之密令自动推进", Category: CategoryBasic, Domain: "basic.flower_pass", Action: "advance", Status: PlanStatusManaged, Executable: true},
	{ID: "basic.elves_pass_sync", Label: "花灵密令同步", Category: CategoryBasic, Domain: "basic.elves_pass", Action: "sync", Status: PlanStatusManaged, Executable: true},
	{ID: "basic.elves_pass", Label: "花灵密令", Category: CategoryBasic, Domain: "basic.elves_pass", Action: "claim", Status: PlanStatusManaged, Executable: true},
	{ID: "basic.elves_pass_advance", Label: "花灵密令自动推进", Category: CategoryBasic, Domain: "basic.elves_pass", Action: "advance", Status: PlanStatusManaged, Executable: true},
	...
	{ID: "basic.pearl_hire", Label: "雇佣劳工", Category: CategoryHire, Domain: "basic.pearl.hire", Action: "hire", Status: PlanStatusManaged, Executable: true},
	{ID: "basic.pearl_buy_hire_ticket", Label: "买雇佣书", Category: CategoryHire, Domain: "basic.pearl.buy_hire_ticket", Action: "buy", Status: PlanStatusAdapterMissing, BlockedReasons: []string{"元宝成本尚未放开自动执行"}},
	...
	{ID: "basic.zoo_buy_food", Label: "购买猫粮", Category: CategoryBasic, Domain: "basic.zoo.buy_food", Action: "buy", Status: PlanStatusManaged, Executable: true},
	{ID: "basic.zoo_buy_food_sync", Label: "宠物商店同步", Category: CategoryBasic, Domain: "basic.zoo.buy_food", Action: "sync", Status: PlanStatusManaged, Executable: true},
	...
	{ID: "activity.actDessert.sync_celebrity", Label: "香卉甜糕名人榜同步", Category: CategoryActivity, Domain: "activity.actDessert", Action: "sync_celebrity", Status: PlanStatusManaged, Executable: true},
	{ID: "activity.actDessert.like_celebrity", Label: "香卉甜糕免费点赞", Category: CategoryActivity, Domain: "activity.actDessert", Action: "like_celebrity", Status: PlanStatusManaged, Executable: true},
