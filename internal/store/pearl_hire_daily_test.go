...
func TestCountPearlHireTicketSpendsSinceFiltersTips4(t *testing.T) {
	...
	events := []struct {
		...
		{dayStart.Add(90 * time.Minute), "pearl_hire", "basic.pearl.hire", "珍珠雇佣成功 槽位=1 劳工=2001 产出=5/次 预计获取珍珠=200"},
		...
		{dayStart.Add(-time.Hour), "pearl_hire", "basic.pearl.hire", "珍珠雇佣成功 槽位=2 预计获取珍珠=200"},
	}
