...
func TestNamespaceCatalogCoversObservedAndModeledNamespaces(t *testing.T) {
	...
	for _, key := range []string{"7", "22", "24", "28", "100", "101", "104", "105", "109", "114", "116", "117", "119", "129"} {
	...
	if IsModeledNamespace("165") {
		t.Fatal("namespace 165 should be known raw-only, not modeled")
	}
}
