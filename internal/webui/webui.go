...
func (h *spaHandler) serveIndex(w http.ResponseWriter, r *http.Request) {
	...
	_, _ = w.Write([]byte(`<!doctype html><html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>小云朵</title></head><body><main style="font-family:sans-serif;max-width:720px;margin:48px auto;line-height:1.6"><h1>当前构建未内嵌完整 Web UI</h1><p>本地 <code>go build</code> / <code>go install</code> 不强制编译前端。请使用 release 二进制，或在发布构建中先执行前端构建并将 <code>web/out</code> 复制到 <code>internal/webui/static</code> 后再编译 <code>gardend</code>。</p></main></body></html>`))
}
